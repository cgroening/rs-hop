...
//! backup and kind.
//!
//! The state and key handling live here; the drawing is a sibling
//! `impl RepoForm` block in [`render`].
//!
...
impl RepoForm {
    ...
    fn move_focus(&mut self, delta: usize) {
        ...
        self.focus =
            ratada::nav::cycle(self.focus, fields.len(), delta as isize);
